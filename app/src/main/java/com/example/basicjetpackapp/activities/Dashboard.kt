...
import com.example.basicjetpackapp.navigation.*
...
fun MainScreen() {
    ...
    Scaffold(
        ...
        drawerBackgroundColor = colorResource(id = R.color.lightgrey),
...
fun Drawer(scope: CoroutineScope, scaffoldState: ScaffoldState, navController: NavController) {
    ...
    Column {
        ...
        Image(
            ...
            contentDescription = R.drawable.full.toString(),
            modifier = Modifier
                .height(100.dp)
                .fillMaxWidth()
                .padding(10.dp)
        ...
        Text(
            text = "Developed by Vipin Shrivatri",
            color = Color.White,
...
fun Navigation(navController: NavHostController) {
    NavHost(navController, startDestination = NavDrawerItem.Home.route) {
        ...
        composable(NavDrawerItem.Info.route) {
            InfoScreen()
        }
